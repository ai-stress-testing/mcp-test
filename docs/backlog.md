...
| MT-26 | Brand guide + funnel copy (real content) | `design/brand-guardian` | sprint-7-26-19-26 | in-progress | [brief](sprint-7-26-19-26/product-brief.md) |
| MT-27 | Landing funnel + owner-dashboard design spec + mockup | `frontend/designer` | sprint-7-26-19-26 | in-progress | [brief](sprint-7-26-19-26/product-brief.md) |
| MT-28 | Conversion-psychology + measurement spec | `academic/psychologist` | sprint-7-26-19-26 | in-progress | [brief](sprint-7-26-19-26/product-brief.md) |
| MT-29 | Analytics + heatmap capture + owner-only auth/reads | `backend/backend-dev` | sprint-7-26-19-26 | in-progress | [brief](sprint-7-26-19-26/product-brief.md) |
| MT-30 | Build the conversion landing funnel | `frontend/react-dev` | sprint-7-26-19-26 | blocked (MT-26,MT-27) | [brief](sprint-7-26-19-26/product-brief.md) |
